        ...
        if (window.wceb) {
            $(window).on('tm-epo-init-events', function (evt, tc) {
                ...
                function tc_adjust_total(total, totals_holder) {
                    ...
                    if (( ( wceb.dateFormat === 'two' && wceb.checkIf.datesAreSet() ) || ( wceb.dateFormat === 'one' && wceb.checkIf.dateIsSet('start') ) ) && parseInt(tm_epo_easy_bookings.wc_booking_block_qty_multiplier, 10) != 0) {
