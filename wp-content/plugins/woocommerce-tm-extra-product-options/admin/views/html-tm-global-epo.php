            ...
            echo '<div class="message0x0 tc-clearfix">'.
                    ...
                    '<div class="message2x2">'.
                            '<select id="tm_meta_cpf_override_final_total_box" name="tm_meta_cpf[override_final_total_box]">'.
                                ...
                                '<option value="options" '.selected(  $tm_override_final_total_box , 'options' ,0) .'>' . __( 'Show only Options total', 'woocommerce-tm-extra-product-options' ) . '</option>'.
                                '<option value="final" '.selected(  $tm_override_final_total_box , 'final' ,0) .'>' . __( 'Show only Final total', 'woocommerce-tm-extra-product-options' ) . '</option>'.
