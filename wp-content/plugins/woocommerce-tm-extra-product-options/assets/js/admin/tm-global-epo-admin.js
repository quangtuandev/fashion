	...
	$.tmEPOAdmin = {
		...
		check_section_logic: function ( section ) {
			...
			section.each( function ( i, el ) {
				...
				var this_section_activate_sections_logic = parseInt( current_section.find( '.activate-sections-logic' ).val(), 10 );
		...
		check_element_logic: function ( element ) {
			...
			element.each( function ( i, el ) {
				...
				var this_element_activate_element_logic = parseInt( el.find( '.activate-element-logic' ).val(), 10 );
		...
		builder_image_delete_onClick: function ( e ) {
			...
			$( this ).closest( "span" ).find("img").attr("src","");			
		},
		...
		// // Variation delete button
		builder_variation_delete_onClick: function ( event ) {
			$.tmEPOAdmin.var_is( "tm-style-variation-forced", true );
			$( ".builder_add_section" ).addClass( "inline" );
			$( ".builder_add_variation" ).addClass( "inline" ).removeClass( "tm-hidden" );	
			$( ".tma-variations-wrap" ).addClass( "tm-hidden" );
					...
					function ( i, el ) {
						$( el ).find( ".tm-default-radio" ).each( function ( index, element ) {
							...
							if ( _name in id_array ) {
								id_array[ _name ] = parseInt( id_array[ _name ], 10 ) + 1;
							} else {
								id_array[ _name ] = 0;
							}
							var _check = false;
