...
*/
	...
	function tm_custom_variations_update( form ) {
		...
		if (! product_id && form.is(composite_selector)){
		...
		function tm_epo_init( $cart_container, $composite_cart ) {
			...
			current_cart
				...
				.on( 'tm-epo-update', function ( pass ) {
					...
					if ( tm_epo_final_total_box == 'pxq' || tm_epo_final_total_box == 'hide' || tm_epo_final_total_box == 'normal' || tm_epo_final_total_box == 'options' || tm_epo_final_total_box == 'final' || tm_epo_final_total_box == 'hideoptionsifzero' ) {
						show_total = true;
					}
					...
					if ( formatted_final_total && tm_epo_final_total_box != 'options' ) {
